...
# 1. Import app settings and base metadata
from src.config.settings import settings
from src.models.base import Base

# 2. IMPORTANT: Import ALL models here so Base.metadata knows about them!
from src.models import Base  # noqa: F401

# Alembic Config object
config = context.config

# Dynamically set database URL from application config (.env)
